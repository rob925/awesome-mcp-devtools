...
- [MCP Shield](https://github.com/rob925/mcp-shield) 🐍 - Static security scanner and MCP server for MCP servers and AI agent tools, with CI-friendly text, JSON, Markdown, and SARIF output.
