...
- [MCP Shield](https://github.com/rob925/mcp-shield) 🐍 - Zero-dependency static security scanner for MCP servers and AI agent tools, with CI-friendly text, JSON, Markdown, and SARIF output.
